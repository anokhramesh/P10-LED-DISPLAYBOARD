...
void setup(void)
{
   ...
   //initialize TimerOne's interrupt/CPU usage used to scan and refresh the display scrolling timer.
   Timer1.initialize( 500 );//period in microseconds to call ScanDMD. Anything longer than 5000 (5s) and you can see flicker.
